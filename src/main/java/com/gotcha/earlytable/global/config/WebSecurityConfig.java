...
public class WebSecurityConfig {
     ...
     * 화이트 리스트.
     */
    private static final String[] WHITE_LIST = {"/users/register", "/users/login", "/users/refresh", "/error", "/stores/*/waiting/offline", "/stores/*/view/**"};
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // 허용할 origin을 설정
        configuration.setAllowedOrigins(List.of("http://localhost:8080", "http://localhost:63342", "http://localhost:3000","https://t1.kakaocdn.net")); // 클라이언트의 주소
